                ...
                <div class="col-md-6">
                    ...
                    <form>
                        <div class="form-group" id="form-unidad-id">
                            ...
                            <input class="form-control" type="text" id="input-id-unidad" placeholder="e.g.:1234"
                                value="<?php echo (isset($_GET['edit'])) ? $unidad->get_idUnidad() : ''; ?>" disabled />
                        </div>
                        <div class="form-group">
                            <label for="input-patente">Patente</label>
                            <input class="form-control" type="text" id="input-patente" placeholder="ABC-123-DF"
                                value="<?php echo (isset($_GET['edit'])) ? $unidad->get_patente() : ''; ?>" />
                        </div>
                        <div class="form-group">
                            <label for="input-fecha-patentamiento">Fecha de Patentamiento</label>
                            <input class="form-control" type="date" id="input-fecha-patentamiento"
                                value="<?php echo (isset($_GET['edit'])) ? $unidad->get_fechaPatentamiento() : ''; ?>" />
                        </div>
                        <div class="form-group">
                            <label for="input-asientos-cama">Asientos Cama</label>
                            <input class="form-control" type="number" id="input-asientos-cama" placeholder="0"
                                value="<?php echo (isset($_GET['edit'])) ? $unidad->get_asientosCama() : ''; ?>" />
                        </div>
                        <div class="form-group">
                            <label for="input-asientos-semi">Asientos Semi Cama</label>
                            <input class="form-control" type="number" id="input-asientos-semi" placeholder="0"
                                value="<?php echo (isset($_GET['edit'])) ? $unidad->get_asientosSemi() : ''; ?>" />
                        </div>
                        <div class="form-group">
                            <label for="select-tipo-unidad">Tipo Unidad</label>
                            <select class="form-control" id="select-tipo-unidad">
                                <option value="1" <?php if (isset($_GET['edit']) && $unidad->get_tipoUnidad() == 1) {
                                    echo 'selected';
                                  } ?>>Cama</option>
                                <option value="2" <?php if (isset($_GET['edit']) && $unidad->get_tipoUnidad() == 2) {
                                    echo 'selected';
                                  } ?>>Semicama</option>
                                <option value="3" <?php if (isset($_GET['edit']) && $unidad->get_tipoUnidad() == 3) {
                                    echo 'selected';
                                  } ?>>Mixto</option>
                                <option value="-1" <?php if (!isset($_GET['edit'])) {
                                      echo 'selected';
